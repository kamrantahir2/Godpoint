      ...
      <div className=" m-auto mb-16">
        <div className="text-center font-oswald font-light w-7/12 m-auto">
          <h3 className="text-4xl">
            Lorem ipsum dolor{" "}
            <span className="text-red-700 uppercase"> sit amet </span>. Ut
            galisum perferendis qui obcaecati porro non vitae voluptatem ut
            beatae error id{" "}
            <span className="text-red-700 uppercase">dolorem quidem</span>.
          </h3>
        </div>
      </div>
    </div>
